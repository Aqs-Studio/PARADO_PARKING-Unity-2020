...
//    public static string id_Remove_ads = "removeads";
//    public static string id_Unlock_All_Levels = "unlocklevels";
...
//        builder.AddProduct(id_Unlock_All_Levels, ProductType.NonConsumable);
...
//    public void Buy_Unlock_All_Levels()
//    {
//        // Buy the non-consumable product using its general identifier. Expect a response either 
//        // through ProcessPurchase or OnPurchaseFailed asynchronously.
//        BuyProductID(id_Unlock_All_Levels);
//    }
...
//      //      GoogleMobileAdsManager.Instance.IsAdsRemoved = true;
//            PlayerPrefs.SetInt("IsAdsRemoved", 1);
//            PlayerPrefs.Save();
//        }

//        else if (String.Equals(args.purchasedProduct.definition.id, id_Unlock_All_Levels, StringComparison.Ordinal))
//        {
//            PlayerPrefs.SetInt("LevelsUnlocked_s", 15);
//            PlayerPrefs.Save();
